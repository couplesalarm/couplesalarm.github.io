...
test("keeps the social video and angled app showcase on the landing page", () => {
  ...
  assert.doesNotMatch(
    html,
    /Four steps|class="fit-check"|Watch the social video|No guesswork|Social launch film|Local by design|Profiles and alarms stay|No account|No microphone|No subscription|\$9\.99 once|proof-list|Footer navigation|play-preview/,
  );
});
